...
import (
	...
	"sigs.k8s.io/cli-utils/pkg/testutil/log"
...
const (
	...
	FieldManager = "cli-utils.sigs.k8s.io/fake-client"
)
...
func (ms *MemoryStorage) TestGet(id kinds.ID) (*unstructured.Unstructured, bool) {
	ms.lock.Lock()
...
func (ms *MemoryStorage) TestGetAll() map[kinds.ID]*unstructured.Unstructured {
	ms.lock.Lock()
	defer ms.lock.Unlock()

	mapCopy := make(map[kinds.ID]*unstructured.Unstructured, len(ms.objects))
...
func (ms *MemoryStorage) putWithoutLock(id kinds.ID, obj client.Object) (*unstructured.Unstructured, bool, error) {
...
func (ms *MemoryStorage) sendPutEvent(ctx context.Context, id kinds.ID, eventType watch.EventType) error {
...
func (ms *MemoryStorage) deleteManagedObjectsWithoutLock(ctx context.Context, parentID kinds.ID) error {
...
func (ms *MemoryStorage) Check(t *testing.T, wants ...client.Object) {
	...
	wantMap := make(map[kinds.ID]client.Object)
	...
	checked := make(map[kinds.ID]bool)
